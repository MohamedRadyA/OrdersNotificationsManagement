...
public enum NotificationTemplate {
    ...
    SUCCESSFUL_SHIPMENT(Map.ofEntries(entry("en","Dear {name}, your order of the {product} has been shipped. Thanks for using our store."),
    ...
    USER_CREATION(Map.ofEntries(entry("en","Dear {name}, your account has been created successfully. Welcome to our store."),
    ...
    ORDER_CANCELLATION(Map.ofEntries(entry("en","Dear {name}, your order of the {product} has been cancelled. We hope to serve you again."),
    ...
    SHIPMENT_CANCELLATION(Map.ofEntries(entry("en","Dear {name}, the shipment of your order of the {product} has been cancelled."),
